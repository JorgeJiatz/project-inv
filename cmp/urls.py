...
from .views import ProveedorView, ProveedorNew, ProveedorEdit, proveedorInactivar, ComprasView, compras, CompraDetDelet
...
urlpatterns = [
    ...
    path('compras/<int:compra_id>/delete/<int:pk>',CompraDetDelet.as_view(), name="compras_del"),    
